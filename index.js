...
function load_boxes() {
    ...
    const boxes = [
        ...
        Box.NormalBox([36, 20, 20], [34.59, 53.95, 80.21, 97.39]),
        Box.NormalBox([36, 24, 10], [32.49, 46.81, 68.43, 82.11]),
        Box.NormalBox([36, 29, 5.5], [45.49, 57.82, 78.60, 91.88]),
        Box.NormalBox([36, 30, 8], [43.49, 57.84, 81.17, 95.79]),
        Box.NormalBox([44, 35, 5.5], [41.49, 55.81, 83.50, 100.51]),
        Box.NormalBox([48, 6, 6], [19.99, 27.45, 36.29, 44.44]),
        Box.NormalBox([48, 10, 10], [22.79, 33.44, 48.44, 59.90]),
        Box.NormalBox([48, 15, 15], [41.50, 58.44, 82.35, 98.39]),
        Box.NormalBox([50, 20, 10], [56.992, 73.41, 97.70, 113.96]),
        Box.NormalBox([56, 32, 10], [81.99, 102.37, 139.64, 163.26]),
